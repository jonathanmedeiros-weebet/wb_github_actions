...
gulp.task('recifeesportes.wee.bet', function (done) {
    tasks(done, {
        ...
        aditional_styles: "body{ background-color: #1f2038!important;  } .mais-opcoes{ color: #1f2038!important; } .indentificacao .nome, .indentificacao .nome-mobile{ color: #1f2038!important; } .sidebar-brand{ margin-top: 0!important; padding-top: 15px; padding-bottom: 20px; background-color: #1f2038; } .sidebar-menu{ background-color: #1f2038; margin-top: 0!important; } .navbar-mobile{ background-color: #1f2038; } .pre-bilhete .div-inputs, .pre-bilhete .valores button, .pre-bilhete .form-group button { background-color: #1f2038!important; } .pre-bilhete .form-group button:hover { color:#fff!important; } .odds .selecionado{ background-color: #f26225!important; } .jogo-selecionado .fa-times{color:#1f2038!important;} .fechar-pre-bilhete .fa-times{color:#1f2038!important;}"
     });
});
