...
@Component({
    ...
    templateUrl: './bilhete-rifa.component.html',
    styleUrls: ['./bilhete-rifa.component.css']
})
export class BilheteRifaComponent extends BaseFormComponent implements OnInit, OnDestroy {
