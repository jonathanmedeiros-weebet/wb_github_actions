...
import { DesafioService, DesafioCategoriaService } from '../services';
...
@NgModule({
    declarations: [DesafiosBilheteComponent, DesafiosListagemComponent, DesafiosWrapperComponent],
    imports: [
        CommonModule,
    ...
    providers: [DesafioService, DesafioCategoriaService]
})
