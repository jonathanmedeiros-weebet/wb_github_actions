...
@Component({
    selector: 'app-exibir-bilhete-superodd',
    templateUrl: 'exibir-bilhete-superodd.component.html',
    styleUrls: ['exibir-bilhete-superodd.component.css']
})

export class ExibirBilheteSuperoddComponent implements OnInit {
