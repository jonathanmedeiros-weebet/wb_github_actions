...
@Component({
    selector: 'app-pre-evento-listagem',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: 'pre-evento-listagem.component.html',
    styleUrls: ['pre-evento-listagem.component.css']
})
export class PreEventoListagemComponent implements OnInit, OnDestroy, OnChanges {
