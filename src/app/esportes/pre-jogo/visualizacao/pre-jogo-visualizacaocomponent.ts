...
@Component({
    selector: 'app-pre-jogo-visualizacao',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: 'pre-jogo-visualizacao.component.html',
    styleUrls: ['pre-jogo-visualizacao.component.css']
})
export class PreJogoVisualizacaoComponent implements OnInit, OnChanges, OnDestroy {
    jogo: Jogo;
    @Input() jogoId;
