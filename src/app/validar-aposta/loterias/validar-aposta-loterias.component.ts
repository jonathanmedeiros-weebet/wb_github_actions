...
@Component({
    selector: 'app-validar-aposta-loterias',
    templateUrl: 'validar-aposta-loterias.component.html',
    styleUrls: ['./validar-aposta-loterias.component.css']
})
export class ValidarApostaLoteriasComponent extends BaseFormComponent implements OnInit, OnDestroy {
